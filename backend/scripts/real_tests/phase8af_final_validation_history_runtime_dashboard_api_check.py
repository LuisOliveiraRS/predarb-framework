...
def main() -> int:
    ...
    with httpx.Client(
        ...
        try:
            ...
            assert "Runtime da Validação Final Paper" in response.text
            assert "Início manual obrigatório" in response.text
        ...
        try:
            ...
            print("       Runtime:", payload["runtime"].get("status"))
            print("       Validação:", payload["validation"].get("status"))
            print("       Histórico:", payload["history"].get("total_entries"))
            passed += 1
        except Exception as exc:
        ...
        try:
            ...
            print("[PASS] Dashboard reflete runtime ativo")
            passed += 1
        except Exception as exc:
        ...
        try:
            ...
            print("[PASS] Captura manual pelo painel")
