...
FILES = {
    ...
    / "app"
    / "paper"
    / "certification_evidence_monitor.py":
        BACKEND
        / "app"
        / "paper"
        / "certification_evidence_monitor.py",
    ...
    / "api"
    / "routers"
    / "paper_certification_evidence_monitor.py":
        BACKEND
        / "app"
        / "api"
        / "routers"
    ...
    PAYLOAD
    / "tests"
    / "test_paper_certification_evidence_monitor.py":
        BACKEND
        / "tests"
        / "test_paper_certification_evidence_monitor.py",
}
    ...
    if IMPORT_LINE not in text:
        ...
        for index, line in enumerate(lines):
            if (
                ...
                and "paper_certification_evidence_router"
                in line
            ):
                lines.insert(
                    index + 1,
