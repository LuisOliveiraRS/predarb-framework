...
FILES = {
    ...
    / "api"
    / "routers"
    / "paper_readiness_runtime_dashboard.py":
        BACKEND
        / "app"
        / "api"
        / "routers"
    ...
    PAYLOAD
    / "tests"
    / "test_paper_readiness_runtime_dashboard.py":
        BACKEND
        / "tests"
        / "test_paper_readiness_runtime_dashboard.py",
}
    ...
    if IMPORT_LINE not in text:
        ...
        for index, line in enumerate(lines):
            if (
                ...
                and "paper_readiness_runtime_router"
                in line
            ):
                lines.insert(
                    index + 1,
