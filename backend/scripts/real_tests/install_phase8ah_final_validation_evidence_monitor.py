...
FILES = {
    ...
    / "app"
    / "paper"
    / "final_paper_validation_evidence_monitor.py":
        BACKEND
        / "app"
        / "paper"
        / "final_paper_validation_evidence_monitor.py",
    ...
    / "api"
    / "routers"
    / "paper_final_validation_evidence_monitor.py":
        BACKEND
        / "app"
        / "api"
        / "routers"
    ...
    PAYLOAD
    / "tests"
    / "test_final_paper_validation_evidence_monitor.py":
        BACKEND
        / "tests"
        / "test_final_paper_validation_evidence_monitor.py",
}
...
IMPORT_LINE = (
    ...
    "paper_final_validation_evidence_monitor "
    "import router as "
...
def patch_application(
    ...
    if IMPORT_LINE not in text:
        ...
        if not inserted:
            raise RuntimeError(
                "Import da Fase 8AG não encontrado."
            )
    ...
    if entry not in text:
        ...
        if not inserted:
            raise RuntimeError(
                "Router da Fase 8AG não encontrado na tupla."
            )
