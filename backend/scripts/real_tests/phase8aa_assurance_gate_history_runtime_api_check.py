...
def wait_for_cycle(
    ...
    *,
    ...
    while (
        ...
        response = client.get(
            "/paper/certification/"
            "assurance/gate/history-runtime/status"
        )
    ...
    raise AssertionError(
        "O ciclo imediato não foi concluído "
        "no tempo esperado."
    )
...
def main() -> int:
    ...
    with httpx.Client(
        ...
        try:
            response = client.get(
                "/paper/certification/"
                "assurance/gate/history-runtime/health"
            )
        ...
        try:
            response = client.post(
                "/paper/certification/"
                "assurance/gate/history-runtime/cycle",
                params={
                    "confirm":
        ...
        try:
            client.post(
                "/paper/certification/"
                "assurance/gate/history-runtime/stop",
                params={
                    "confirm":
            ...
            response = client.post(
                "/paper/certification/"
                "assurance/gate/history-runtime/start",
                params={
                    "confirm":
        ...
        try:
            response = client.get(
                "/paper/certification/"
                "assurance/gate/history-runtime/last-cycle"
            )
