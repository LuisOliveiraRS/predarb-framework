...
FILES = {
    ...
    / "app"
    / "paper"
    / "certification_assurance_gate.py":
        BACKEND
        / "app"
        / "paper"
        / "certification_assurance_gate.py",
    ...
    / "api"
    / "routers"
    / "paper_certification_assurance_gate.py":
        BACKEND
        / "app"
        / "api"
        / "routers"
    ...
    PAYLOAD
    / "tests"
    / "test_paper_certification_assurance_gate.py":
        BACKEND
        / "tests"
        / "test_paper_certification_assurance_gate.py",
}
...
def patch_application(
    ...
    if IMPORT_LINE not in text:
        ...
        if not inserted:
            raise RuntimeError(
                "Imports das fases 8W/8X não foram encontrados."
            )
    ...
    if entry not in text:
        ...
        if not inserted:
            raise RuntimeError(
                "Routers das fases 8W/8X não foram encontrados na tupla."
            )
