...
FILES = {
    ...
    / "app"
    / "paper"
    / "certification_evidence_incident_runtime.py":
        BACKEND
        / "app"
        / "paper"
        / "certification_evidence_incident_runtime.py",
    ...
    / "api"
    / "routers"
    / "paper_certification_evidence_incident_runtime.py":
        BACKEND
        / "app"
        / "api"
        / "routers"
    ...
    PAYLOAD
    / "tests"
    / "test_paper_certification_evidence_incident_runtime.py":
        BACKEND
        / "tests"
        / "test_paper_certification_evidence_incident_runtime.py",
}
...
IMPORT_LINE = (
    ...
    "paper_certification_evidence_incident_runtime "
    "import router as "
...
def patch_application(
    ...
    if IMPORT_LINE not in text:
        ...
        if not inserted:
            raise RuntimeError(
                "Imports das fases 8Q/8R não encontrados."
            )
    ...
    if entry not in text:
        ...
        if not inserted:
            raise RuntimeError(
                "Routers das fases 8Q/8R não encontrados na tupla."
            )
