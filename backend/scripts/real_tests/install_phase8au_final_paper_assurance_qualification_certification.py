...
FILES = {
    ...
    / "app"
    / "paper"
    / "final_paper_assurance_qualification_certification.py":
        BACKEND
        / "app"
        / "paper"
        / "final_paper_assurance_qualification_certification.py",
    ...
    / "api"
    / "routers"
    / "paper_final_assurance_qualification_certification.py":
        BACKEND
        / "app"
        / "api"
        / "routers"
    ...
    PAYLOAD
    / "tests"
    / "test_final_paper_assurance_qualification_certification.py":
        BACKEND
        / "tests"
        / "test_final_paper_assurance_qualification_certification.py",
}
...
def patch_application(
    ...
    if IMPORT_LINE not in text:
        ...
        if not inserted:
            raise RuntimeError(
                "Import da Fase 8AT não encontrado."
            )
    ...
    if entry not in text:
        ...
        if not inserted:
            raise RuntimeError(
                "Router da Fase 8AT não encontrado na tupla."
            )
