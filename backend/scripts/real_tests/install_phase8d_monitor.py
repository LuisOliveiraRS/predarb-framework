...
FILES = {
    ...
    PAYLOAD
    / "tests"
    / "test_paper_performance_monitor.py":
        BACKEND
        / "tests"
        / "test_paper_performance_monitor.py",
}
...
def insert_import(
    ...
    raise RuntimeError(
        ...
        "um import de router Paper."
    )


def insert_router_entry(
    text: str,
) -> str:
    entry = (
        "        "
