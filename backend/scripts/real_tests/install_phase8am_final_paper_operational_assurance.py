...
FILES = {
    ...
    / "app"
    / "paper"
    / "final_paper_operational_assurance.py":
        BACKEND
        / "app"
        / "paper"
        / "final_paper_operational_assurance.py",
    ...
    / "api"
    / "routers"
    / "paper_final_operational_assurance.py":
        BACKEND
        / "app"
        / "api"
        / "routers"
    ...
    PAYLOAD
    / "tests"
    / "test_final_paper_operational_assurance.py":
        BACKEND
        / "tests"
        / "test_final_paper_operational_assurance.py",
}
...
def patch_application(
    ...
    if IMPORT_LINE not in text:
        ...
        if not inserted:
            raise RuntimeError(
                "Imports das fases 8AK/8AL não foram encontrados."
            )
    ...
    if entry not in text:
        ...
        if not inserted:
            raise RuntimeError(
                "Routers das fases 8AK/8AL não foram encontrados na tupla."
            )
