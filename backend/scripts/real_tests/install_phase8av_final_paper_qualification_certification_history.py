...
FILES = {
    ...
    / "app"
    / "paper"
    / "final_paper_qualification_certification_history.py":
        BACKEND
        / "app"
        / "paper"
        / "final_paper_qualification_certification_history.py",
    ...
    / "api"
    / "routers"
    / "paper_final_qualification_certification_history.py":
        BACKEND
        / "app"
        / "api"
        / "routers"
    ...
    PAYLOAD
    / "tests"
    / "test_final_paper_qualification_certification_history.py":
        BACKEND
        / "tests"
        / "test_final_paper_qualification_certification_history.py",
}
...
def patch_application(
    ...
    if IMPORT_LINE not in text:
        ...
        if not inserted:
            raise RuntimeError(
                "Import da Fase 8AU não encontrado."
            )
    ...
    if entry not in text:
        ...
        if not inserted:
            raise RuntimeError(
                "Router da Fase 8AU não encontrado na tupla."
            )
