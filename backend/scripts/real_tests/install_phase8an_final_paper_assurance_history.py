...
FILES = {
    ...
    / "app"
    / "paper"
    / "final_paper_operational_assurance_history.py":
        BACKEND
        / "app"
        / "paper"
        / "final_paper_operational_assurance_history.py",
    ...
    / "api"
    / "routers"
    / "paper_final_operational_assurance_history.py":
        BACKEND
        / "app"
        / "api"
        / "routers"
    ...
    PAYLOAD
    / "tests"
    / "test_final_paper_operational_assurance_history.py":
        BACKEND
        / "tests"
        / "test_final_paper_operational_assurance_history.py",
}
...
def patch_application(
    ...
    if IMPORT_LINE not in text:
        ...
        if not inserted:
            raise RuntimeError(
                "Import da Fase 8AM não encontrado."
            )
    ...
    if entry not in text:
        ...
        if not inserted:
            raise RuntimeError(
                "Router da Fase 8AM não encontrado na tupla."
            )
