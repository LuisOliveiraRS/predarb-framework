...
FILES = {
    ...
    / "app"
    / "paper"
    / "final_paper_assurance_qualification_gate_history_runtime.py":
        BACKEND
        / "app"
        / "paper"
        / "final_paper_assurance_qualification_gate_history_runtime.py",
    ...
    / "api"
    / "routers"
    / "paper_final_assurance_qualification_gate_history_runtime.py":
        BACKEND
        / "app"
        / "api"
        / "routers"
    ...
    PAYLOAD
    / "tests"
    / "test_final_paper_assurance_qualification_gate_history_runtime.py":
        BACKEND
        / "tests"
        / "test_final_paper_assurance_qualification_gate_history_runtime.py",
}
...
IMPORT_LINE = (
    ...
    "paper_final_assurance_qualification_gate_history_runtime "
    "import router as "
...
def patch_application(
    ...
    if IMPORT_LINE not in text:
        ...
        if not inserted:
            raise RuntimeError(
                "Import da Fase 8AR não encontrado."
            )
    ...
    if entry not in text:
        ...
        if not inserted:
            raise RuntimeError(
                "Router da Fase 8AR não encontrado na tupla."
            )
