...
FILES = {
    ...
    / "app"
    / "paper"
    / "final_paper_validation_history.py":
        BACKEND
        / "app"
        / "paper"
        / "final_paper_validation_history.py",
    ...
    / "api"
    / "routers"
    / "paper_final_validation_history.py":
        BACKEND
        / "app"
        / "api"
        / "routers"
    ...
    PAYLOAD
    / "tests"
    / "test_final_paper_validation_history.py":
        BACKEND
        / "tests"
        / "test_final_paper_validation_history.py",
}
...
def patch_application(
    ...
    if IMPORT_LINE not in text:
        ...
        if not inserted:
            raise RuntimeError(
                "Import da Fase 8AC não encontrado."
            )
    ...
    if entry not in text:
        ...
        if not inserted:
            raise RuntimeError(
                "Router da Fase 8AC não encontrado na tupla."
            )
