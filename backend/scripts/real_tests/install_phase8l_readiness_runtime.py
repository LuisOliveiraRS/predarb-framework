...
FILES = {
    ...
    PAYLOAD
    / "tests"
    / "test_paper_readiness_runtime.py":
        BACKEND
        / "tests"
        / "test_paper_readiness_runtime.py",
}
    ...
    if IMPORT_LINE not in text:
        ...
        for index, line in enumerate(lines):
            if (
                ...
                and "paper_readiness_history_router"
                in line
            ):
                lines.insert(
                    index + 1,
