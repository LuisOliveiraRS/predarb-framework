...
def test_manual_cycle_captures_gate_report():
    storage = []
    ...
    assert result["gate_status"] == "QUALIFIED"
...
def test_application_registers_runtime_routes():
    ...
    from app.api.routers.paper_certification_assurance_gate_history_runtime import (
        router,
    )
