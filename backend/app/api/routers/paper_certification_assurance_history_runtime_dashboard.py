...
<head>
  ...
  >
  <title>PredArb | Runtime do Histórico da Garantia</title>
...
<body>
  <main>
    <header>
      <div>
        <h1>Runtime do Histórico da Garantia</h1>
        <p class="muted">
          Captura periódica e controlada do Centro de Garantia Paper.
        </p>
      </div>
  ...
  <script>
    ...
    function render(payload) {
      ...
      document.getElementById(
        ...
        card(
          ...
          normalizeClass(assurance.status)
        ),
        card(
          "Score atual",
          Number(
    ...
    async function startRuntime() {
      const confirmed = window.confirm(
        "Iniciar o runtime do histórico do Centro de Garantia?"
      );
      ...
      await post(
        ...
        + "?confirm=START-PAPER-ASSURANCE-HISTORY-RUNTIME"
    ...
    async function stopRuntime() {
      const confirmed = window.confirm(
        "Parar o runtime do histórico da garantia?"
      );
      ...
      await post(
        ...
        + "?confirm=STOP-PAPER-ASSURANCE-HISTORY-RUNTIME"
      );
    ...
    async function runCycle() {
      const confirmed = window.confirm(
        "Registrar agora o snapshot do Centro de Garantia Paper?"
      );
    ...
    async function resetStatistics() {
      ...
      await post(
        ...
        + "?confirm=RESET-PAPER-ASSURANCE-HISTORY-RUNTIME"
      );
...
async def assurance_history_runtime_dashboard():
    return HTMLResponse(
...
@router.get("/snapshot")
async def assurance_history_runtime_dashboard_snapshot():
    runtime = (
        paper_assurance_history_runtime
        .status()
    )
