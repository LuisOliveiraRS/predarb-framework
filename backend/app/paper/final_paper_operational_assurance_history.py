...
class FinalPaperOperationalAssuranceHistory:
    """Histórico persistente da Garantia Operacional Final Paper."""
    ...
    def _validate_report(
        ...
        if status not in cls.VALID_STATUSES:
            raise ValueError(
                "Status da garantia final inválido."
            )
        ...
        if (
            ...
            raise ValueError(
                "O relatório deve ter escopo PAPER_ASSURANCE_ONLY."
            )
        ...
        if not isinstance(
            ...
            raise ValueError(
                "Lista de checks da garantia final inválida."
            )
        ...
        if not isinstance(
            ...
            raise ValueError(
                "Lista de falhas da garantia final inválida."
            )
        ...
        if not isinstance(
            ...
            raise ValueError(
                "Resumo da garantia final inválido."
            )
    ...
    def _validate_entry(
        ...
        if status not in cls.VALID_STATUSES:
            raise ValueError(
                "Status de entrada da garantia final inválido."
            )
        ...
        if (
            ...
            raise ValueError(
                "Escopo da entrada da garantia final inválido."
            )
    ...
    def load(self) -> dict[str, Any]:
        with self._lock:
            ...
            if not isinstance(
                ...
                raise ValueError(
                    "Arquivo do histórico da garantia final inválido."
                )
            ...
            if not isinstance(
                ...
                raise ValueError(
                    "Lista do histórico da garantia final inválida."
                )

            self._validate_safety(
                "final_assurance_history_state",
                payload,
            )
            ...
            for entry in payload["entries"]:
                if not isinstance(
                    ...
                    raise ValueError(
                        "Entrada do histórico da garantia final inválida."
                    )
        ...
        *,
        ...
        return {
            ...
            "summary": {
                ...
                "validation_history_entries": _integer(
                    summary.get(
    ...
    def summary(
        ...
        current_streak_status, current_streak = (
